...
export const setReadOne = async (notiId, userId) => Notification.updateOne({ _id: notiId, userId }, { read: true })

export const getUnreadNotiCount = async (userId) => Notification.countDocuments({ userId, read: false })
